...
export default async function LoginPage({ searchParams }: { searchParams: Promise<Record<string,string|undefined>> }) {
  ...
  return <main className="login-shell"><section className="login-card"><span className="brand-mark"><Gauge size={19}/></span><div className="eyebrow" style={{marginTop:18}}>私人情報工作台</div><h1>臺灣汽機車拍賣情報</h1><p className="muted">這是私人唯讀儀表板。輸入設定的擁有者信箱，我們會寄送一次性登入連結。</p>
